...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,filename):
        ...
        img = pygame.image.load("C:\Python310\Pacman Game\PacMan\walk.png").convert()
        ...
        img = pygame.image.load("C:\Python310\Pacman Game\PacMan\lifeover.png").convert()
        self.lifeover_animation = Animation(img,30,30)
        self.player_image = pygame.image.load(filename).convert()
        self.player_image.set_colorkey(BLACK)

    def update(self,horizontal_blocks,vertical_blocks):
        if not self.lifeover:
            ...
            if self.lifeover_animation.index == self.lifeover_animation.get_length() -1:
                pygame.time.wait(500)
                self.game_over = True
            self.lifeover_animation.update(12)
            self.image = self.lifeover_animation.get_current_image()
